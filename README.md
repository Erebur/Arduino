...
Eine Android App, in der man mit einem Joystick steuern kann. Die Geschwindigkeit sollte per Slider veränderbar sein und die Musik kann auch in der App ausgewählt werden.